...
#' Release Version 7.0 01/024/2024
...
ui <-
  dashboardPage( skin="green", 
                 ...
                 dashboardHeader(title = span(img(src="co_dola__NoText-dept.png", height = 45, align = "top"),"Colorado Demographic Profiles"), titleWidth=550), #dashboardHeader
